  ...
  return (
    ...
    >
      ...
      <TextField
        ...
        type="number"
        step="any"
        defaultValue={minDeliveryTime}
        onChange={(e) => {
          let value = parseInt(e.target.value);
          if (isNaN(value)) {
            setErrors((errors) => ({
              ...errors,
              minDeliveryTime: "Value must be a valid number",
            }));
            return;
          }
          if (onChange) {
      ...
      <TextField
        ...
        onChange={(e) => {
          ...
          if (isNaN(value)) {
            setErrors((errors) => ({
              ...errors,
              maxDeliveryTime: "Value must be a valid number",
            }));
            return;
          }
          if (onChange) {
      ...
      <TextField
        ...
        onChange={(e) => {
          ...
          if (isNaN(value)) {
            setErrors((errors) => ({
              ...errors,
              rating: "Value must be a valid number",
            }));
            return;
          }
          if (onChange) {
